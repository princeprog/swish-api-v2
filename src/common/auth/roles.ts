...
export const ORGANIZATION_PERMISSIONS = {
  COMPLIANCE_REQUIREMENTS_MANAGE: 'compliance_requirements_manage',
  COMPLIANCE_SUBMISSIONS_READ_ASSIGNED: 'compliance_submissions_read_assigned',
  COMPLIANCE_SUBMISSIONS_REVIEW: 'compliance_submissions_review',
  ...
  GAME_STATS_ASSIGNED: 'game.stats.assigned',
  GAME_STATS_OVERRIDE: 'game.stats.override',
...
const STATISTICIAN_PERMISSIONS: OrganizationPermission[] = [
  ORGANIZATION_PERMISSIONS.GAMES_READ_ASSIGNED,
...
> = {
  ...
  [AUTH_ROLES.STATISTICIAN]: STATISTICIAN_PERMISSIONS,
